...
class MovieRelation(RelationBase):
    ...
    fields = (
        ...
        (
            "ignore",
            _("Don't want to watch"),
            _("Don't want to watch"),
            _("don't want to watch movie"),
            _("You don't want to watch movie %s"),
        ),
        (
            "have",
            _("Have in collection"),
            _("Have in collection"),
            _("got to collection movie"),
...
get_user_model().add_to_class(
    "familiar_movies",
    models.ManyToManyField(Movie, verbose_name=_("Relations"), through=MovieRelation, related_name="relations_users"),
)

...
class ImdbSyncMixin:
    ...
    fixtures = ["imdb.imdbgenre.json", "imdb.imdbcountry.json", "imdb.imdblanguage.json"]
    ...
    def assert_matrix(self, imdb_movie):
        ...
        self.assertEqual(imdb_movie.id, 133_093)
    ...
    def assert_matrix_cast(self, imdb_movie, person1, person2, person3):
        ...
        self.assertEqual(person1.imdb.id, 905_152)
    ...
    def assert_dennis_hopper_career(self, imdb_person, movie1, movie2):
        ...
        self.assertEqual(movie2.imdb.id, 108_399)

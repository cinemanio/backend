...
class Movie(BaseModel):
    ...
    year = models.PositiveSmallIntegerField(
        ...
        null=True,
        db_index=True,
        help_text=_("Year in between {} and {}".format(YEARS_RANGE[0], YEARS_RANGE[1])),
        validators=[MinValueValidator(YEARS_RANGE[0]), MaxValueValidator(YEARS_RANGE[1])],
    )
    ...
    sequel_for = models.ForeignKey(
        "Movie",
        verbose_name=_("Sequel for movie"),
        related_name="prequels",
        blank=True,
        null=True,
        on_delete=models.CASCADE,
    )
    prequel_for = models.ForeignKey(
        "Movie",
        verbose_name=_("Prequel for movie"),
        related_name="sequels",
        blank=True,
        null=True,
        on_delete=models.CASCADE,
    )
    remake_for = models.ForeignKey(
        "Movie",
        verbose_name=_("Remake of movie"),
